...
class LibraryManagement{
    ...
    void addBook() {
        ...
        String name = sc.nextLine().trim(); // Use nextLine to allow multi-word titles and trim to remove spaces
        
        System.out.println("Enter the Author name");
        String auth = sc.nextLine().trim(); // Use nextLine to allow multi-word names and trim
        ...
        map.put(bk, 1);  // Assuming each book added starts with 1 copy
